        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              const Gap(12),
              const Text("최소 50만원 ~ 최대 1억원 사이에서 설정해주세요."),
              const Gap(12),
              TextFormField(
                controller: priceTextEditingController,
                decoration: const InputDecoration(hintText: "목표 금액을 입력해주세요."),
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(hintText: "메이커 명을 입력해주세요."),
              ),
              const Gap(24),
              const Text(
                "대표 이미지",
              ...
              const Gap(12),
              Text(
                "메인, 검색 결과, SNS 광고 등 여러 곳에서 노출할 대표 이미지를 등록해주세요.",
                style: TextStyle(
